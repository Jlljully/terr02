...
4. Была ошибка синтаксическая сначала - standatD, потом обнаружилось, что стардартов у яндекса не 4, а 3, я выбрала второй. Выяснила, что он не поддерживает 1-ядерную конфигурацию, поменяла на 2 и ВМ развернулась.
